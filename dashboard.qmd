...
pedestrian_data = pd.read_csv('~/Documents/GitHub/Urban-Futures-a-NYC_Hackathon/data/Pedestrian_Data.csv')
...
#| echo: false
import geopandas as gpd
community_orgs = pd.read_excel('~/Documents/GitHub/Urban-Futures-a-NYC_Hackathon/data/community_orgs.xlsx')
